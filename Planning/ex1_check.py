...
def main():
    problems = [
                (problem_blocked_center_3x3,                    "problem_blocked_center_3x3",                 0),
                (problem_1x1_out_of_bounds,                     "problem_1x1_out_of_bounds",                   0),
                (problem_1x2_two_robots_no_overlap,             "problem_1x2_two_robots_no_overlap",   0),
                (problem_no_enough_water,             "problem_no_enough_water",   None),
                (problem_isolated_plant,             "problem_isolated_plant",   None),
                (problem1,                  "problem1",                 8),
                ...
                (problem_hard7,            "problem_hard7",             37),
                (problem_12x12_snake_hard, "problem_12x12_snake_hard",  343),
                (problem_check,            "problem_check",             75),
